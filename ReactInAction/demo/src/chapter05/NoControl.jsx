    ...
    render() {
        return (
            <section>
                ...
                <p>What a coincidence, I also own <strong>{this.state.numberOfCats}</strong> cat(s).</p>

                <p>
                    You can, however, still update the state and the value will be updated, try clicking the buttons below to force an update
                </p>
